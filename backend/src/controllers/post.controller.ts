...
export const createPost = async (req: Request, res: Response) => {
  ...
  // Owner is the author-designated assignee, if any. Questions/Problems require
  // an assignee; Ideas leave the post open (ownerId null) for team discussion.
  // No section-owner mapping or Founder fallback — the author routes the post.
  const ownerId = assigneeId ? Number(assigneeId) : null;
